...
if(isset($_POST['btnsave']))
{
           ...
           $upquery="update tbl_customer set customer_name='".$name."',customer_address='".$address."',customer_email='".$email."' where customer_id='".$_SESSION["cid"]."'";          
		   mysql_query($upquery); 
...
<title>GTMobileHub::User EditProfile</title>
<?php
