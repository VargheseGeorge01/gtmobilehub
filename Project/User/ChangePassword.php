...
if($count>0)
{
	...
	{
		$upquery="update tbl_customer set customer_password='".$newpwd."' where customer_id='".$_SESSION["cid"]."'";         mysql_query($upquery);
...
<head>
<title>GTMobileHub::User ChangePassword</title>
<?php
